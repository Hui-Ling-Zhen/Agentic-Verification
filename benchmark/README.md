...
├── ablation_simulated.json    # Generated by make ablation-simulate
...
| `scripts/ablation_simulate.py` | Generates synthetic A/B/C ablation manifests so the benchmark shape can be reviewed before real Codex runs. |
