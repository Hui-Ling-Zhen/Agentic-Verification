...
from veriagent.abackend.base import AgentBackendBase
from veriagent.util.log import info, warning, error
from .middleware import MessageStatistic, TokenSpeedCallbackHandler, TrimAndSummaryMiddleware
from langchain.agents import create_agent
from langgraph.checkpoint.memory import MemorySaver
from veriagent.util.models import get_chat_model
from langchain_core.messages import HumanMessage, SystemMessage, AIMessage, ToolMessage
from veriagent.util.functions import dump_as_json, get_ai_message_tool_call


class VeriAgentLangChainBackend(AgentBackendBase):
    """
