...
from veriagent.checkers.unity_test import BaseUnityChipCheckerTestCase
from typing import Tuple
import inspect
from veriagent.checkers.toffee_report import check_report
...
class RandomTestCasesChecker(BaseUnityChipCheckerTestCase):
    ...
    4. Verifies the use of 'veriagent.repeat_count' for setting repeat counts.
    ...
    def __init__(self, target_test_file, mini_file_count=1, min_test_count=1,
                 ...
                 must_func_code_snippet={"veriagent.repeat_count": "you must use this function to set the repeat count for random test cases.",
