...
class PdbCmdApiServer:
    ...
    def __init__(
        ...
        if sock is None:
            sock = f"/tmp/veriagent_cmd_{port}.sock"
        elif sock == "":
            sock = None
        ...
        from veriagent.util import log
    ...
    def _build_app(self):  # noqa: C901 – intentionally long; each section is self-contained
        ...
        app = FastAPI(
            title="VeriAgent PDB CMD API",
            description=(
                "REST API for inspecting the VeriAgent VerifyPDB instance. "
        ...
        class _AuthMiddleware(BaseHTTPMiddleware):
            async def dispatch(self, request: _Request, call_next):
                ...
                return _JSONResponse(
                    ...
                    headers={"WWW-Authenticate": 'Basic realm="VeriAgent CMD API"'},
                )
