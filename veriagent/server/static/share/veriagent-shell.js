(function(){
  var STORAGE_KEY = 'veriagent.theme';
  ...
  function ensureFavicon(){
    ...
    link.href = '/static/share/veriagent-favicon.svg';
  }
  ...
  function renderFooterText(){
    ...
    footer.innerHTML =
      '<strong>' + escapeHtml(metaState.product || 'VeriAgent') + '</strong>' +
  ...
  function fetchMeta(url){
    ...
    fetch(url, { credentials: 'same-origin' })
      ...
      .then(function(payload){
        ...
        metaState.product = data.product || 'VeriAgent';
