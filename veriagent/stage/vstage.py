# -*- coding: utf-8 -*-
"""Verification stage management for VeriAgent."""

from veriagent.util.functions import import_class_from_str, find_files_by_pattern
import veriagent.util.functions as fc
import veriagent.util.diff_ops as diff_ops
from veriagent.util.log import info, warning
from veriagent.util.config import Config
import veriagent.checkers as checkers
...
class VerifyStage(object):
    ...
    def __init__(self,
        ...
        self.hist_sav_dir = fc.get_abs_path_cwd_veriagent(workspace, "history")
