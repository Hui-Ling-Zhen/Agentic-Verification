# -*- coding: utf-8 -*-
"""File operations tools for VeriAgent."""

from typing import Optional, List, Tuple
from veriagent.util.log import info, str_info, str_return, str_error, str_data, warning
from veriagent.util.functions import is_text_file, get_file_size, bytes_to_human_readable, copy_indent_from, rm_workspace_prefix
from veriagent.util.functions import get_diff, match_pattern_list
...
class SearchText(UCTool, BaseReadWrite):
    ...
    def __init__(self, workspace: str, ignore_hidden: bool = True,
                 ignore_pattern_list: list[str] = [".git/*", "*/data/*", ".veriagent/*", "uc_test_report/*", "*.dat", "*.fst"],
                 **kwargs):
        """Initialize the tool."""
