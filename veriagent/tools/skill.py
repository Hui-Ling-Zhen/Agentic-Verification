# -*- coding: utf-8 -*-
"""Skills management tools for VeriAgent.
...
from veriagent.util.log import warning,info
...
class ListSkill(UCTool):
    ...
    def _run(self, *args, **kwargs) -> str:
        ...
        if not skills_path.exists():
            raise ValueError(f"Skill directory not found: {skills_path}. You need to start VeriAgent with arg(--use-skill) to copy skills into the workspace.")
