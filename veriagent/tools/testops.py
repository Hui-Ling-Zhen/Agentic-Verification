# -*- coding: utf-8 -*-
"""Test operations tools for VeriAgent."""
...
from veriagent.util.test_tools import veriagent_lib_path
from veriagent.util.functions import get_toffee_json_test_case, load_toffee_report
from veriagent.util.log import debug, info, warning
import os
import shutil
import psutil
...
class RunPyTest(UCTool):
    ...
    def do(self,
        ...
        python_path_str = os.path.abspath(os.getcwd()) + ":" + veriagent_lib_path()
