# -*- coding: utf-8 -*-
"""Logging utilities for VeriAgent."""
...
def init_log_logger(name: str = "veriagent-log", level: int = logging.DEBUG,
                log_file:str="log/veriagent-log.log"):
...
def init_msg_logger(name: str = "veriagent-msg", level: int = logging.INFO,
                log_file:str="log/veriagent-msg.log"):
