...
from veriagent.util.functions import find_files_by_glob, find_files_by_regex, find_files_by_pattern, render_template_dir
...
def test_render_template_dir():
    ...
    template = os.path.join(current_dir, "../veriagent/lang/zh/template/unity_test")
    context = {"DUT": "alu"}
...
def test_parse_marks_from_file():
    ...
    test_file = os.path.join(current_dir, "../veriagent/lang/zh/template/unity_test/{{DUT}}_line_coverage_analysis.md")
...
def test_parse_line_ignore_file():
    ...
    test_file = os.path.join(current_dir, "../veriagent/lang/zh/template/unity_test/tests/{{DUT}}.ignore")
...
def test_markdown_headers():
    ...
    test_file = "../veriagent/lang/zh/doc/Guide_Doc/dut_spec_template.md"
...
def test_markdown_get_miss_headers():
    ...
    target_file = "../veriagent/lang/zh/doc/Guide_Doc/dut_spec_template.md"
    source_file = "../veriagent/lang/zh/doc/Guide_Doc/dut_test_template.md"
