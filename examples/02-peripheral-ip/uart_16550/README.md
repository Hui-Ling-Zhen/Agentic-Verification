# uart_16550 — 16550A UART

## 验证故事

验证典型 SoC 外设 IP：APB 寄存器、TX/RX FIFO、波特率、中断与 Modem 信号。
...
| 项 | 值 |
|----|-----|
| Workflow | `examples/02-peripheral-ip/workflow/default.yaml` |

```bash
make example-peripheral
# 或：make mcp_uart_16550
```
...
- [Examples 索引](../../README.md) · [02-peripheral-ip 索引](../README.md)
