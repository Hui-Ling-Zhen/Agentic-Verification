...
# Bootstrap: Add VeriAgent project root to sys.path so we can import 'veriagent'.
...
from veriagent.lang.zh.skills.formal.lib.formal_tools import run_formal_verification, summarize_execution
