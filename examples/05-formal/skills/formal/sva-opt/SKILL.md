...
3. 调用 `veriagent.checkers.formal.PropertyStructureChecker`。系统会自动根据最新的 YAML 渲染并覆盖 `checker.sv`，确保新断言生效。
...
```bash
python3 .veriagent/skills/formal/sva-opt/scripts/run_formal_verification.py -timeout 3600
```
