...
```bash
python3 .veriagent/skills/formal/bug-report/scripts/init_bug_report.py
```

### 2. 查看待填写条目

```bash
python3 .veriagent/skills/formal/bug-report/scripts/update_bug.py -action show
```
...
```bash
python3 .veriagent/skills/formal/bug-report/scripts/update_bug.py \
  -id BG-FORMAL-001 \
  -fg_id FG-ARITHMETIC \
  -fc_id FC-ADD-BASIC \
