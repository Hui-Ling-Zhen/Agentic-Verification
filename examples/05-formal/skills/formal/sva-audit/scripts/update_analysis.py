...
# Bootstrap: Add VeriAgent project root to sys.path
_root = os.path.dirname(os.path.abspath(__file__))
while _root != os.path.dirname(_root) and not os.path.exists(os.path.join(_root, "veriagent", "__init__.py")):
...
from veriagent.lang.zh.skills.formal.lib.models import FormalRecords, AnalysisEntry, AnalysisData
from veriagent.util.log import str_error, str_info, warning
