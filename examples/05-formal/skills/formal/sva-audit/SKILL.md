...
```bash
python3 .veriagent/skills/formal/sva-audit/scripts/update_analysis.py -action show
```
...
```bash
python3 .veriagent/skills/formal/sva-audit/scripts/update_analysis.py \
  -type tt -id TT-001 \
...
```bash
python3 .veriagent/skills/formal/sva-audit/scripts/env_analysis.py -mode update
```
...
```bash
python3 .veriagent/skills/formal/func-spec/scripts/update_spec.py -action set_param -id WIDTH -value 64
```
...
应使用 `add_signal` 动作：
```bash
python3 .veriagent/skills/formal/func-spec/scripts/update_spec.py -action add_signal -desc "logic [WIDTH-1:0] my_internal_sig"
```
